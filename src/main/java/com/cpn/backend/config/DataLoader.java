...
public class DataLoader {
    ...
    public CommandLineRunner loadData(MasalaProductRepository repository) {
        return args -> {
            ...
            p1.setImageUrl("/img/sec3.jpg"); // using existing
            ...
            p1.setIdealWith(Set.of(IdealWith.BREAKFAST, IdealWith.LUNCH_DINNER));
            ...
            p2.setImageUrl("/img/sec2.png"); // using existing
            ...
            p2.setIdealWith(Set.of(IdealWith.BREAKFAST, IdealWith.LUNCH_DINNER));
